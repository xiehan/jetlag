...
- If you're a tea drinker, bring your own tea bags, particularly ones with low/no caffeine (I personally am a huge fan of rooibos)
...
- Unless you got a really solid night's sleep on the plane, you'll want to take a nap as soon as possible when you arrive. It's up to you to do the mental math, but the goal is to make it to 9pm tonight, so if you think you can't do that without a nap, go ahead and do it ASAP.
  ...
  - This is the one exception to the Golden Rule above about never napping more than 90 minutes: **this nap is allowed to be up to 3.5~4 hours long**. Basically, the goal is to get about half a night's rest, or ~3 full sleep cycles. Set an alarm clock for +4 hours from now.
...
- Once you're awake from your nap, follow the instructions in the next section ("In the afternoon").
...
- Then, follow the instructions in the next section ("In the evening").
...
- You'll probably wake up feeling quite hungry, so go and eat a good breakfast. Just don't overeat so much that you want to immediately go back to your room and nap. The mission today is to try to make it to 9pm without napping at all in between if possible.
...
- It may seem like a minor thing, but focus on eating at normal mealtimes and avoiding snacking. If you're really struggling, though, that's why you brought those granola bars.
- You will probably still want to take your melatonin or sleep aid of choice at night. The same challenges with sleeping through the last night typically still persist on the second night.
